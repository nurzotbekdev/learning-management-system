...
function Courses() {
  ...
  const totalCourses = Object.values(CoursesData.Courses).flat().length;
  ...
  return (
    <>
      ...
      <div className="px-[4%] md:px-[6%] lg:px-[8%] xl:px-[10%] py-[6%] bg-[#f3f9ff] relative">
        <div className="flex justify-between items-center flex-wrap gap-3 mb-6 cursor-pointer">
          <p className="text-gray-600">
            ...
            of{" "}
            <span className="font-semibold text-[#f37739]">{totalCourses}</span>{" "}
            Results
          </p>
